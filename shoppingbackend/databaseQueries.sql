...
INSERT INTO category (name, description,image_url,is_active) VALUES ('RAM', 'This is description for RAM category!', 'CAT_1.png', true);
INSERT INTO category (name, description,image_url,is_active) VALUES ('MOTHERBOARD', 'This is description for MOTHERBOARD category!', 'CAT_2.png', true);
INSERT INTO category (name, description,image_url,is_active) VALUES ('GRAPHICS CARD', 'This is description for baby GRAPHICS CARD category!', 'CAT_3.png', true);
...
VALUES ('PRDABC123DEFX', 'Ram', 'Vengeance', 'Gaming Ram', 9000, 120, true, 1, 2, 0, 0 );

INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABC124DEFX', 'MOTHERBOARD', 'GIGABYTE', 'Great quality gaming Motherboard', 10000, 80, true, 1, 2, 0, 0 );

INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABC125DEFX', 'GRAPHICS CARD', 'Radeon', 'Great quality Graphics Card', 25000, 75, true, 1, 2, 0, 0 );

INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABC223DEFX', 'Ram', 'Vengeance', 'Gaming Ram', 9000, 120, true, 1, 2, 0, 0 );

INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABC224DEFX', 'MOTHERBOARD', 'GIGABYTE', 'Great quality gaming Motherboard', 10000, 80, true, 1, 2, 0, 0 );

INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABC225DEFX', 'GRAPHICS CARD', 'Radeon', 'Great quality Graphics Card', 25000, 75, true, 1, 2, 0, 0 );
